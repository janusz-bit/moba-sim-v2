...
struct Champion {
  ...
  // A PassiveEntry pairs a passive with a unique id generated by PassiveFactory.
  // The id is used by Champion::addPassive to deduplicate: inserting an entry
  // whose id already exists replaces the existing passive (refresh), otherwise
